...
function wrapper(plugin_info) {
    ...
    var imgBtn = window.jQuery('<div id="amap-float-btn" style="position:fixed;left:33vw;bottom:10px;z-index:9999;width:32px;height:32px;cursor:pointer;border-radius:16px;box-shadow:0 2px 8px rgba(0,0,0,0.2);background:#fff;display:flex;align-items:center;justify-content:center;" title="高德地图">'
